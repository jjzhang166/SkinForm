...
{
    class SkinFormHook : NativeWindow
    {
        #region Fields

        // form data
        private SkinForm _owner;
        bool _isFormAttached;
        bool _isAssignHandle;   // Is the Handle has assigned.
        ...
        private bool IsProcessNcArea
        {
            get
            {
                ...
                return
                    !(_owner == null
                      || _owner.SkiningForm.MdiParent != null 
                      && _owner.SkiningForm.WindowState == FormWindowState.Maximized);
            }
        }

        public bool IsFormAttached
        {
            get { return _isFormAttached; }
            set { _isFormAttached = value; }
        }
        ...
        public SkinFormHook(SkinForm parentForm)
        {

            _owner = parentForm;
            _isFormAttached = false;
            _isAssignHandle = false;
        }
